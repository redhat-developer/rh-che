...
public class ZabbixHistoryParams {
    ...
    public ZabbixHistoryParams(Integer history, Set<String> hostids, Set<String> itemids, Long time_from, Long time_till, String sortfield, String sortorder, Integer limit, Set<String> output, Set<String> selectitems) {
